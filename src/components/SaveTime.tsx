...
export function SaveTime(){
    return (
        <div className="py-12 px-2 w-full min-h-screen bg-[#F3F3F3]">
            <div className='container pt-8 mx-auto px-4'>
                ...
                <div className="flex flex-row flex-wrap">
                    ...
                    <div className="flex-auto lg:w-1/2 w-full flex flex-col justify-center">
                        ...
                        <div className="flex flex-row flex-wrap  w-full gap-3 pb-8">
                            {
                                data.map((item, index) => {
                                    return (
                                        <div key={"precious--item--" + index} className="md:w-5/12 flex-auto w-full flex gap-2  mb-3 items-center">
                                            <Image 
                                                width={18}
                                                height={18}
                                                src="/check.svg"
                        ...
                        <div className="flex flex-row items-center py-6 border border-black px-4 rounded-xl md:max-w-sm w-full">
